...
<section style="padding:0 0 76px">
  <div class="wrap">
    <div class="final">
      ...
      <h2>무엇이 필요하신지만 알려주세요</h2>
      <div class="fp">{TEL}</div>
      <p class="fn">평일 09:00 – 18:00 · 영업 070-4509-0770 · 기술 070-4509-0766</p>
      <div class="fbtn">
        <a href="tel:{TEL_RAW}" class="btn btn-white">전화 상담</a>
        <a href="/#lead" class="btn" style="background:rgba(255,255,255,.16);color:#fff">무료 상담신청</a>
      </div>
    </div>
  </div>
</section>
...
<footer>
  <div class="wrap">
    ...
    <div class="info">
      ...
      고객센터 {TEL} · 영업 070-4509-0770 · 기술 070-4509-0766 · help@ziotes.com<br>
