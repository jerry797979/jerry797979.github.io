...
LOGOS = [
 ...
 ("icon21", "도움과나눔"),
 # 2026-09-02 추가 — 사장님이 주신 자료(구글 슬라이드)에 있던 곳들
 ("koreauniv",     "고려대학교"),        ("ktnet",         "한국무역정보통신"),
 ("crinity",       "크리니티"),          ("trenbe",        "트렌비"),
 ("enjoysoft",     "엔조이소프트"),       ("sysmate",       "시스메이트"),
 ("daon",          "다온홈시스"),        ("komi",          "한국기계산업진흥회"),
 ("hanbit",        "한빛이엔에스"),       ("softmill",      "소프트밀"),
 ("tublet",        "터블렛"),            ("kohas",         "코하스아이디"),
 ("csrental",      "씨에스렌탈"),        ("stagefive",     "스테이지파이브"),
 ("elandpark",     "이랜드파크"),        ("myeongpum",     "명품플라워"),
 ("anytek",        "애니텍시스"),        ("scaffolding",   "한국비계기술원"),
 ("wolhospital",   "건강한월병원"),       ("marslabs",      "마스랩스"),
 ("haengbok",      "행복이룸"),          ("weaversbrain",  "위버스브레인"),
 ("plansclinic",   "플랜에스클리닉"),     ("alllineclinic", "올라인클리닉"),
 ("hansclean",     "한스클린"),          ("tiffanywedding","티파니웨딩"),
 ("ohjin",         "오진양행"),          ("tantancore",    "탄탄코어"),
 ("theteentimes",  "틴타임즈"),      ("ajeongdang",    "아정당 상조"),
]
...
CLIENTS = [
 ("통신·IT", ["KT olleh", "LG U+", "SK네트웍스", "kt cs", "넥스트네트워크",
             "LG상사", "엠피온", "한국무역정보통신", "크리니티", "엔조이소프트",
             "시스메이트", "소프트밀", "스테이지파이브", "탄탄코어"]),
 ("교육", ["YBM시사닷컴", "정철", "아발론교육", "문깡 잉글리시스쿨", "스피크케어",
          "멀티캠퍼스", "스터디맥스", "틴타임즈", "아이보린", "고려대학교", "터블렛"]),
 ("공공·기관", ["울산광역시 교육연구정보원", "축산물안전관리인증원", "의왕도시공사",
              "한국기계산업진흥회", "행복커넥트", "공직메일", "한국비계기술원"]),
 ("병원·클리닉", ["건강한월병원", "플랜에스클리닉", "올라인클리닉", "마스랩스"]),
 ("제조·유통·서비스", ["삼성SDI 서비스센터", "홍국F&B", "카누다",
                   "바이오인프라", "씨에스렌탈", "다온홈시스", "웰컴론", "도움과나눔",
                   "이랜드파크", "트렌비", "명품플라워", "애니텍시스", "한빛이엔에스",
                   "코하스아이디", "한스클린", "티파니웨딩", "오진양행", "위버스브레인",
                   "행복이룸", "아정당 상조"]),
]
